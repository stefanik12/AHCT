...
mapping = {
	"What level of independence does the subject have in their daily life?":
		{"Able to live independently": 1, "Requires some assistance with complex activities": 2, "Requires som assistance with basic activities": 3, "Completely dependent": 4, "Unknown": np.nan},
	...
	"Shopping for groceries or other household necessities?":
		{"Normal":0, "Has difficutly, but does by self":1, "Requires assistance":2, "Dependent":3,"Not applicable (e.g., never did)":np.nan, "Unknown":np.nan},
